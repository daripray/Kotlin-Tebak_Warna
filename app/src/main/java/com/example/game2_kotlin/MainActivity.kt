...
//    //    private val arrColorsNameEN = arrayOf("WHITE", "BLUE", "RED", "GREEN", "GRAY", "YELLOW")
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        btnRight = findViewById(R.id.btnRight) as Button
        btnWrong = findViewById(R.id.btnWrong) as Button
        txtColor = findViewById(R.id.txtColor) as TextView
        txtLevel = findViewById(R.id.txtLevel) as TextView
